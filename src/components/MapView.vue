  ...
  <div class="h-full relative">
    ...
    <div class="absolute top-2 right-2 z-[30] flex gap-1">
      ...
      <button
        @click="toggleHeatmap"
        :class="{
          'bg-blue-500 text-white shadow-md': showHeatmap,
          'bg-white/90 text-gray-600 hover:bg-white': !showHeatmap
        }"
        class="p-2 rounded-md shadow-sm border border-gray-200 transition-all duration-200"
      ...
      <button
        ...
        :class="{
          'bg-blue-500 text-white shadow-md': showFiltersPanel,
          'bg-white/90 text-gray-600 hover:bg-white': !showFiltersPanel
        }"
        class="p-2 rounded-md shadow-sm border border-gray-200 transition-all duration-200"
